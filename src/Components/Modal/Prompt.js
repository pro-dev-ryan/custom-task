...
const Prompt = ({ setConfirm, setpermit }) => {
  return (
    <div className="w-2/3 top-[30vh] bg-white shadow-md fixed md:w-1/2 flex flex-col ring ring-teal-700 md:flex-row gap-3 p-3 md:p-5 rounded-lg">
